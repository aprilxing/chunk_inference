...
smooth_data_window = 10; % moving average window of smoothing data
...
master_path = ['/Users/april/Library/CloudStorage/Box-Box/Motor Chunking Analysis/', patient_id_simple, '/', subfolder_name, '/', parsing_condition];
file_name = [patient_id_simple, ', ', condition, ' Day 2-4', ', begin with ', trial_begin_condition, ', ', plot_mode, ', ', '11-Dec-2023']; %char(datetime('today'))
mat_name = [master_path, '/', file_name, '.mat'];
load(mat_name, [patient_id_simple, '_day2'], [patient_id_simple, '_day3'], [patient_id_simple, '_day4'], 'condition', 'recording_rate', 'trial_num_per_seq', 'seqs', 'actual_seqs', 'block_order')
...
subject_id = ones(100, 1);
subject_id2 = ones(100, 1);
sample_table = table(subject_id, subject_id2);
