...
addParameter(p, 'fit_rt', false, @islogical);
addParameter(p, 'fit_er', false, @islogical);
addParameter(p, 'fit_rt_rt', false, @islogical);
addParameter(p, 'fit_er_er', false, @islogical);
addParameter(p, 'fit_T', true, @islogical);
addParameter(p, 'fit_rho', false, @islogical);
addParameter(p, 'fit_rho_er', false, @islogical);
addParameter(p, 'diagonal_T', false, @islogical);
addParameter(p, 'rho', 0.1, @isscalar);
addParameter(p, 'rho_er', 0.1, @isscalar);
addParameter(p, 'self_t', 0.6, @isscalar);
addParameter(p, 'verbose', false, @islogical);
addParameter(p, 'mean_pause', 0.1, @isnumeric);
addParameter(p, 'mean_inchunk', 0, @isnumeric);
addParameter(p, 'mean_pause_er', 0.1, @isnumeric);
addParameter(p, 'mean_inchunk_er', 0, @isnumeric);
addParameter(p, 'chunks', []);
addParameter(p, 'cor_chunks', []);

varargin = {'verbose', true, ...
